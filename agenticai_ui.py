...
# HEADER
# -------------------------------------------------
st.markdown("## 🎧 Spotify-Like Agentic Music Recommender")
st.caption("Agentic AI · Reinforcement Learning · iTunes Album Art")
...
with st.sidebar:
    ...
    generate = st.button("▶ Play Recommendations")

# -------------------------------------------------
# MAIN CONTENT
# -------------------------------------------------
if generate:
    st.success("🎶 Fresh recommendations ready")
        ...
        with col2:
            st.markdown(
                ...
                <div class="spotify-card">
                    ...
                    <div class="badge">
                        {row['strategy']} · Reward {row['reward']}
                    </div>
                </div>
                """,
                unsafe_allow_html=True
